...
import 'package:fitness_app_flutter/model/softDrinkModel.dart';
...
class SoftDrinkTabScreen extends StatefulWidget {
  const SoftDrinkTabScreen({Key? key}) : super(key: key);

  @override
  State<SoftDrinkTabScreen> createState() => _SoftDrinkTabScreenState();
}

class _SoftDrinkTabScreenState extends State<SoftDrinkTabScreen> {
  ...
  SoftDrinkModel softDrinkModel = SoftDrinkModel();
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: List.generate(
                      softDrinkModel.softDrinkModelData.length,
                      (index) => softDrinkModel.softDrinkModelData[index]
                                  ["title"] !=
                              null
                          ? InkWell(
                              onTap: () {
                                _onSelected(index);
                                liquidType = softDrinkModel
                                    .softDrinkModelData[index]["title"];
                              },
                              child: Container(
                                ...
                                child: font14Textnormal(
                                  text: softDrinkModel.softDrinkModelData[index]
                                      ["title"],
                                  color: _selectedIndex != null &&
                                          _selectedIndex == index
                                      ? whitecolor
                  ...
                  children: List.generate(
                      ...
                      (index) => InkWell(
                            onTap: () {
                              ...
                              quantity = softDrinkModel
                                  .softDrinkModelData[index]["amount"];
                            },
                            child: Container(
                              margin: const EdgeInsets.all(5),
                              alignment: Alignment.center,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image.asset(
                                    softDrinkModel.softDrinkModelData[index]
                                        ["img"],
                                    height: 30,
                                    color: _selectedIndexx != null &&
                                            _selectedIndexx == index
                                  ...
                                  font14Textnormal(
                                    text:
                                        "${softDrinkModel.softDrinkModelData[index]["amount"]} ml",
                                    color: _selectedIndexx != null &&
                                            _selectedIndexx == index
                                        ? whitecolor
                                        : blackcolor,
